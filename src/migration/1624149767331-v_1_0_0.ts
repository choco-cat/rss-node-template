...
export class v1001624149767331 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      await queryRunner.query(`CREATE TABLE "user" ("id" character varying NOT NULL, "name" character varying(35), "login" character varying(35), "password" character varying(60), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
    }
