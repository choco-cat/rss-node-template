 ...
 */
const getAllTasks = async (boardId: string): Promise<ITask[]|Error> => tasksRepo.getAll(boardId);
/**
 ...
 */
const addTask = async (taskRow: typeof Task): Promise<ITask|Error> => tasksRepo.addTask(taskRow);
/**
 ...
 */
const updateTask = async (taskRow: typeof Task): Promise<ITask|Error> => tasksRepo.updateTask(taskRow);
/**
 ...
 */
const deleteTask = async (taskId: string): Promise<boolean|Error> => tasksRepo.deleteTask(taskId);
/**
 ...
 */
const deleteTasksFromUser = async (userId: string): Promise<ITask[]|Error> => tasksRepo.deleteTasksFromUser(userId);
